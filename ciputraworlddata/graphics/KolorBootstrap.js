...
function eventKrpanoLoaded () {
	...
	ktools.I18N.getInstance().initLanguage('en', crossDomainTargetUrl+'ciputraworlddata/ciputraworld_messages_en.xml');
	krpanoLoaded = true;
...
function addKolorArea(pPlugID)
{
	...
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"ciputraworlddata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"ciputraworlddata/graphics/KolorArea/KolorArea.min.js", [], true);
...
function addKolorFloorPlan(pPlugID, pContent)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorFloorPlanCSS = new ktools.CssStyle("KolorFloorPlanCSS", crossDomainTargetUrl+"ciputraworlddata/graphics/KolorFloorPlan/kolorFloorPlan.css");
		var kolorFloorPlanJS = new ktools.Script("KolorFloorPlanJS", crossDomainTargetUrl+"ciputraworlddata/graphics/KolorFloorPlan/KolorFloorPlan.min.js", [], true);
...
function showKolorFloorPlan(pPlugID, pContent)
{
	...
	if(!kolorFloorPlan.isReady())
	{
		...
		//set url for images
		kolorFloorPlan.setGraphicsUrl(crossDomainTargetUrl+"ciputraworlddata/graphics/"+pPlugID.toLowerCase()+"/");
